...
public static class TypeReflector
{
    ...
    public static FieldAccessor<TInstance, TFieldType>? GetFieldAccessor<TInstance, TFieldType>(
    this Type type, string fieldName, BindingFlags bindingFlags = DefaultLookup)
    {
